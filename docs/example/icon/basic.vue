<template>
  <div grid="~ cols-14 gap-4" un-children="text-6">
    ...
    <o-icon o-green name="i-carbon-letter-gg" />
    ...
    <o-icon o-gray name="i-carbon-letter-nn" />
    ...
    <o-icon o-gray name="i-carbon-letter-tt" />
    ...
    <o-icon o-gray name="i-carbon-letter-zz" />
    <o-icon name="i-logos:vue" />
    <o-icon name="i-logos:vitejs" />
    <o-icon name="i-logos:unocss" />
    <o-icon name="i-logos:typescript-icon" />
    <o-icon name="i-logos:github-copilot" />
    <o-icon name="i-logos:element" />
    <o-icon name="i-logos:discord-icon" />
    <o-icon name="i-logos:twitter" />
    <o-icon name="i-logos:sketch" />
    <o-icon name="i-logos:spotify" />
    <o-icon name="i-logos:youtube-icon" />
    <o-icon name="i-logos:panda" />
    <o-icon name="i-logos:adonisjs-icon" />
    <o-icon name="i-logos:awesome" />
    <o-icon name="i-logos:appwrite-icon" />
    <o-icon name="i-logos:gopher" />
  </div>
</template>
