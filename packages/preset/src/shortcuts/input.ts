...
const Size: Record<SizeType, string> = {
  xs: `${controlHeight.xs} px-2 py-1 text-xs`,
  sm: `${controlHeight.sm} px-2.5 py-1 text-sm`,
  md: `${controlHeight.md} px-3 py-1 text-sm`,
  lg: `${controlHeight.lg} px-4 py-2 text-sm`,
}
