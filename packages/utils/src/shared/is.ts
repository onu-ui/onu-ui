...
export const isComponent = (vn: VNode, _type?: VNodeTypes): _type is Component => Boolean(vn && vn.shapeFlag & ShapeFlags.COMPONENT)
export const isElement = (vn: VNode) => Boolean(vn && vn.shapeFlag & ShapeFlags.ELEMENT)
export const isText = (vn: VNode, _children: VNode['children']): _children is string => Boolean(vn && vn.shapeFlag & ShapeFlags.TEXT_CHILDREN)
export const isSlotsChildren = (vn: VNode, _children: VNode['children']): _children is Slots => Boolean(vn && vn.shapeFlag & ShapeFlags.SLOTS_CHILDREN)
export const isArrayChildren = (vn: VNode, _children: VNode['children']): _children is VNode[] => Boolean(vn && vn.shapeFlag & ShapeFlags.ARRAY_CHILDREN)
